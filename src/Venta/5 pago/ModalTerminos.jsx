  ...
  return (
    <div className="modal-terminos-overlay">
      <div className="modal-terminos w-75">
        ...
        <div>
          <strong>Métodos de Pago:</strong> El pago se realiza con tarjeta de crédito o débito. Algunas tarjetas pueden ser rechazadas y no se aceptan tarjetas extranjeras.
        </div>
        <div>
