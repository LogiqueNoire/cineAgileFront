...
const FTextInput = ({ valorPorDefecto, label, onSave, atributo }) => {
    ...
    return (
        <div className="input-group">
            <div className="form-floating">
                <input className="form-control" id={ label } placeholder={ label } disabled={ modo != "edit" } value={ input } onChange={ (evt) => setInput(evt.target.value) } type="text" />
